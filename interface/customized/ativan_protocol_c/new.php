...
$check_res= $formid ? formFetch("form_ativan_protocol_c", $formid) : array();
...
<html>
    ...
    <body>
       <div class="container-fliud m-4">
        <div class="row ">
            <div class="col-12">
           <form method="post" name="my_form" action="<?php echo $rootdir; ?>/customized/ativan_protocol_c/save.php?id=<?php echo attr_url($formid); ?>">
                <input type="hidden" name="csrf_token_form" value="<?php echo attr(CsrfUtils::collectCsrfToken()); ?>" />       
                <h3>Ativan Protocol C</h3>
                        <br/>
