...
function ativan_protocol_c_report($pid, $encounter, $cols, $id)
{
    $count=0;
    $sql = "SELECT * FROM `form_ativan_protocol_c` WHERE id=$id AND pid =$pid AND encounter =$encounter";
    ...
    if ($data) {
        ...
        <table style='width: 100%;'>
            <tr>
                ...
                <td><span><?php echo xlt('Ativan Protocol c'); ?></span></td>
            </tr>
            <br/>
            <tr>
