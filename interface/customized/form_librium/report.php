...
function form_librium_report($pid, $encounter, $cols, $id)
{
    $count=0;
    $sql = "SELECT * FROM `form_librium` WHERE id=$id AND pid =$pid AND encounter =$encounter";
    ...
    if ($data) {
        ...
        <table style='width: 100%;'>
            ...
            <th><label><?php echo xlt(' DOB :'); ?></label></th>
                <td><span class=text style="margin-left: -1121px;"><?php echo xlt(text($data['input3'])); ?></span></td>
            </tr>
            <tr>
