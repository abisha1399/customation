...
if ($id && $id != 0) {
    sqlStatement("UPDATE `form_librium` SET `input1`=?,`input2`=?,`input3`=?,`input4`=?,`input5`=?,`input6`=?,`input7`=?,`input8`=?,`input9`=?,`input10`=?,`input11`=?,`input12`=?,`input13`=?,`input14`=?,`input15`=?,`input16`=?,`input17`=?,`input18`=?,`input19`=?,`input20`=?,`input21`=?,`input22`=?,`input23`=?,`input24`=?,`input25`=?,`input26`=?,`input27`=?,`input28`=?,`input29`=?,`input30`=?,`input31`=?,`input32`=?,`input33`=?,`input34`=?,`input35`=?,`input36`=?,`input37`=?,`input38`=?,`input39`=?,`input40`=?,`input41`=?,`input42`=? WHERE id =?", array($input1,$input2,$input3,$input4,$input5,$input6,$input7,$input8,$input9,$input10,$input11,$input12,$input13,$input14,$input15,$input16,$input17,$input18,$input19,$input20,$input21,$input22,$input23,$input24,$input25,$input26,$input27,$input28,$input29,$input30,$input31,$input32,$input33,$input34,$input35,$input36,$input37,$input38,$input39,$input40,$input41,$input42,$id));
}else 
{

    $newid = sqlInsert("INSERT INTO `form_librium`(`pid`,`encounter`,`input1`,`input2`,`input3`,`input4`,`input5`,`input6`,`input7`,`input8`,`input9`,`input10`,`input11`,`input12`,`input13`,`input14`,`input15`,`input16`,`input17`,`input18`,`input19`,`input20`,`input21`,`input22`,`input23`,`input24`,`input25`,`input26`,`input27`,`input28`,`input29`,`input30`,`input31`,`input32`,`input33`,`input34`,`input35`,`input36`,`input37`,`input38`,`input39`,`input40`,`input41`,`input42`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
    ...
    addForm($encounter, "librium Form", $newid, "form_librium",  $_SESSION["pid"], $userauthorized);
}
