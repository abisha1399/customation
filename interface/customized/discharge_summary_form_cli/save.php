...
if ($id && $id != 0) {
    ...
    sqlStatement("UPDATE `discharge_summary_cli` SET input1=?, input2=?, input3=?, input4=?, input5=?, 
...
}else 
{
    // echo "test";
    // die();
    $newid = sqlInsert("INSERT INTO `discharge_summary_cli` (pid,encounter,input1,input2,input3,input4,input5,input6,comment1,checkbox1,checkbox2,checkbox3,checkbox4,checkbox5,checkbox6,comment2,comment3,comment4,comment5,comment6,comment7,comment8,comment9) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)", 
    ...
    addForm($encounter, "discharge summary form", $newid, "discharge_summary_form_cli",  $_SESSION["pid"], $userauthorized);
}
