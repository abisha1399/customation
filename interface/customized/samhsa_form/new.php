      ...
      <div class="row">
        ...
        <div class="col-8">
          <table style="width:100%; color: #fff; background-color: #0a508c; ">
            ...
            <tr> 
              <td style="width:100%; text-align:center; font-size:18px;padding-bottom:250px;">
                <img src="../../forms/samhsa_form/opioid.jpg" width="100%" alt="">
              </td>
            </tr>
          </table>
          ...
          <table style="width:100%;">
            ...
            <tr>
              <td style="width:100%; color: #000; padding-left: 40px; padding-right: 40px;">
              This publication may be ordered from SAMHSA’s Publications Ordering Web page at <a style="text-decoration: underline"><a href="https://store.samhsa.gov/" target=
              "_blank">https://store.samhsa.gov/</a>. Or, please call SAMHSA at 1-877- SAMHSA-7 (1-877-726-4727) (English).
              </td>
            </tr>
            ...
            <tr>
              <td style="width:100%; color: #000; padding-left: 40px; padding-right: 40px;padding-bottom:100px;">
          ...
          <table style="width:100%;">
            ...
            <tr>
              <td style="width:100%; padding-left: 40px;">
                ...
                <p style="padding-bottom:100px;"><b>References...............................................................................................................................22</b></p>
              </td>
            </tr>
          </table>
          ...
          <table style="width:100%; padding-bottom:10px;">
            <tr>
              <td style="width:60%; border-right:1px solid black;">
                ...
                <p style="padding-left: 40px; padding-right: 10px;"><b style="color: #0a508c;">WHAT ARE OPIOIDS?</b> Opioids include illegal drugs such as heroin, as well as prescription medications used to treat pain such as morphine, codeine, methadone, oxycodone (OxyContin®, Percodan®, Percocet®), hydrocodone (Vicodin®, Lortab®, Norco®), fentanyl (Duragesic®, Fentora®), hydromorphone (Dilaudid®, Exalgo®), and buprenorphine (Subutex®, Suboxone®). &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Opioids work by binding to specific receptors in the brain, spinal cord, and gastrointestinal tract. In doing so, they minimize the body’s perception of pain. However, stimulating the opioid receptors or “reward centers” in the brain can also trigger other systems of the body, such as those responsible for regulating mood, breathing, and blood pressure.</p>
                <p style="padding-left: 40px; padding-right: 10px;"><b style="color: #0a508c;">HOW DOES OVERDOSE OCCUR?</b> A variety of effects can occur after a person takes opioids, ranging from pleasure to nausea, vomiting, severe allergic reactions (anaphylaxis), and overdose, in which breathing and heartbeat slow or even stop. &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Opioid overdose can occur when a patient deliberately misuses a prescription opioid or an illicit drug such as heroin. It can also occur when a patient takes an opioid as directed, but the prescriber miscalculated the opioid dose or an error was made by the dispensing pharmacist or the patient is understood the directions for use. &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Also at risk are individuals who misuse opioids and combine them with sedative hypnotic agents resulting in sedation and respiratory depression.  5,6</p>
              </td>
              <td style="width:40%;  padding-left: 10px; vertical-align: unset;">
                ...
                <ul style="list-style-type: square; color:#0a508c;">
                  <li><span style="color:#000;">Receiving rotating opioid medicationregimens (and thus are at risk forincomplete cross-tolerance).</span></li>
                  <li><span style="color:#000;">Discharged from emergency medical care following opioid intoxication or poisoning.</span></li>
                  <li><span style="color:#000;">At high risk for overdose because of a legitimate medical need for analgesia, coupled with a suspected or confirmed substance use disorder, or non-medical use of  rescription or illicit opioids.</span></li>
                  <li><span style="color:#000;">Completing mandatory opioid detoxification or abstinent for a period of time (and presumably with reduced opioid tolerance and high risk of relapse to opioid use).</span></li>
                  <li><span style="color:#000;">Recently released from incarceration and who have a history of opioid use disorder (and presumably have reduced opioid tolerance and high risk of relapse to opioid use).</span></li>
                </ul>
                <div style="background-color: #0a508c; padding:10px; color:#fff;text-align: center;">
                  <p>
          ...
          <table>
            <tr>
              ...
              <p>&emsp;&emsp;Federally funded Continuing Medical Education courses are available to providers at no charge at <span style="text-decoration: underline"><a href="http://www.OpioidPrescribing.com" target=
              "_blank">http://www.OpioidPrescribing.com/</a></span> (a series of courses funded by the Substance Abuse and Mental Health Services Administration [SAMHSA]).</p>

              <p>&emsp;&emsp;Helpful information for laypersons on how to prevent and manage overdose is available from Project Lazarus at <span style="text-decoration: underline"><a href="http://www.projectlazarus.org" target=
              "_blank">http://www.projectlazarus.org</a></span> or from the Massachusetts Health Promotion Clearinghouse at <span style="text-decoration: underline"><a href="http://www.maclearinghouse.org" target=
              "_blank">http://www.maclearinghouse.org</a></span> </p>
          ...
          <table>
            <tr>
              <td style="width:85%; padding-left: 40px; padding-right:10px;margin-top:20px;">
                <p>&emsp;&emsp;Naloxone does not have the potential for abuse. It reverses the effects of opioid overdose. 9 Injectable naloxone is relatively inexpensive. It typically is supplied as a kit with two syringes10 These kits require training on how to administer naloxone using a syringe. The FDA has also approved an intranasal naloxone product, called Narcan® Nasal Spray, and a naloxone auto-injector, called  Evzio®. The intranasal spray is a pre-filled, needle-free device that requires no assembly. The auto-injector can deliver a dose of naloxone through clothing, if necessary, when placed on the outer thigh.</p>

                <p>&emsp;&emsp;Prior to 2012, just six states had any laws that expanded access to naloxone or limited criminal liability.11 Today, 42 states and the District of Columbia have statutes that provide criminal liability protections to laypersons or first  esponders who administer naloxone. Thirty-nine states and the District of Columbia have statutes that provide civil liability protections to laypersons or first responders who administer naloxone. Thirty-eight states have statutes that offer criminal liability protections for prescribing or distributing naloxone. Thirty-three states have statutes that offer civil liability protections for prescribing or distributing naloxone. And 42 states have statutes that allow naloxone distribution to third parties or first responders via direct prescription or standing order. To find states that have adopted relevant laws, visit the White House website at <span style="text-decoration: underline"> <a href="www.whitehouse.gov/sites/default/files/ondcp/" target="_blank">www.whitehouse.gov/sites/default/files/ondcp/</a>  </span>
                <span style="text-decoration: underline"> <a href="Blog/naloxonecirclechart_january2016.pdf." target="_blank">Blog/naloxonecirclechart_january2016.pdf.</a> </span></p>
          ...
          <table>
            <tr>
              <td style="width: 85%; padding-left: 40px; padding-right: 10px; vertical-align: baseline;">
                <b style="color: #0a508c;font-size:25px;">RESOURCES FOR COMMUNITIES</b>
                <p>Resources that may be useful to local communities and organizations are found at:</p>
                <p style="color: #0a508c;"><b>Substance Abuse and Mental Health Services Administration (SAMHSA)</b></p>
                <ul style="list-style-type: square; color: #0a508c;">
                  ...
                  <p style="color:#000;color:#000;"><span style="text-decoration:underline;"><a href="https://findtreatment.samhsa.gov" target="_blank">https://findtreatment.samhsa.gov</a></span> to search by address, city, or zip code</p>
                  <li><span style="color:#000;">Buprenorphine Treatment Physician Locator:</span></li>
                  <p style="text-decoration:underline;color:#000;"><a href="http://www.samhsa.gov/medication-assisted-treatment/physician-program-data/treatment-physician-locator" target="_blank">http://www.samhsa.gov/medication-assisted-treatment/physician-program-data/treatment-physician-locator</a></p>
                  <li><span style="color:#000;">State Substance Abuse Agencies:</span></li>
                  <p style="text-decoration:underline;color:#000;"><a href="https://findtreatment.samhsa.gov/TreatmentLocator/faces/about.jspx" target="_blank">https://findtreatment.samhsa.gov/TreatmentLocator/faces/about.jspx</a></p>
                  <li><span style="color:#000;">Center for Behavioral Health Statistics and Quality (CBHSQ):</span></li>
                  <p style="text-decoration:underline;color:#000;"><a href="http://www.samhsa.gov/data">http://www.samhsa.gov/data</a></p>
                  <li><span style="color:#000;">SAMHSA Publications:</span> <span style="text-decoration:underline;color:#000;"><a href="http://store.samhsa.gov">http://store.samhsa.gov</a></span></li>
                  <p style="color:#000;">1-877-SAMHSA (1-877-726-4727)</p>
                </ul>
                <b style="color: #0a508c;">Centers for Disease Control and Prevention (CDC)</b>
                <p style="text-decoration:underline;"><a href="http://www.cdc.gov/drugoverdose/epidemic">http://www.cdc.gov/drugoverdose/epidemic</a></p>
                <p style="text-decoration:underline; line-height: 0;"><a href="http://www.cdc.gov/homeandrecreationalsafety/poisoning">http://www.cdc.gov/homeandrecreationalsafety/poisoning</a></p>
                <b style="color: #0a508c;">White House Office of National Drug Control Policy (ONDCP)</b>
                <p>State and Local Information: <span style="text-decoration:underline;"><a href="http://www.whitehouse.gov/ondcp/state-map" target="_blank">http://www.whitehouse.gov/ondcp/state-map</a></span></p>
                <b style="color: #0a508c;">Association of State and Territorial Health Officials</b>
                <p>(ASTHO) ASTHO 214 Policy Inventory: State Action to Prevent and Treat Prescription Drug Abuse: <span style="text-decoration:underline;"><a href="http://www.astho.org/rx/profiles/Rx-Survey-Highlights" target="_blank">http://www.astho.org/rx/profiles/Rx-Survey-Highlights</a></span></p>
                <b style="color: #0a508c;">National Association of State Alcohol and Drug Abuse Directors (NASADAD)</b>
                <p>Overview of State Legislation to Increase Access to Treatment for Opioid Overdose:</p>
                <p style="text-decoration:underline;"><a href="http://nasadad.org/wp-content/uploads/2015/09/Opioid-Overdose-Policy-Brief-2015-Update-FINAL1.pdf" target="_blank">http://nasadad.org/wp-content/uploads/2015/09/Opioid-Overdose-Policy-Brief-2015-Update-FINAL1.pdf</a></p>
                <b style="color: #0a508c;">American Association for the Treatment of Opioid Dependence (AATOD)</b>
                <p>Prevalence of Prescription Opioid Abuse:</p>
                <p style="text-decoration:underline;"><a href="http://www.aatod.org/projectseducational-training/prevalance-of-prescription-opioid-abuse" target="_blank">http://www.aatod.org/projectseducational-training/prevalance-of-prescription-opioid-abuse</a></p>
              </td>
          ...
          <table style="width:100%;">
            <tr>&emsp;
              ...
              <td style="width:70%; vertical-align:unset; padding-left:10px; padding-right:10px;">
                  ...
                  <b style="color:#0a508c; font-size:30px;">STEP 2: CHECK FOR SIGNS OF OPIOID OVERDOSE</b>
                  <p>Signs of <b style="color: #0a508c;">OVERDOSE</b>, which often results in death if not treated, include15:</p>
                  <ul style="list-style-type: square; color:#0a508c;">
          ...
          <table style="width:100%;">
            <tr>&emsp;
              <td style="width:60%; border-right:1px solid black; font-size:14px; padding-right:10px;vertical-align:unset;">
                  ...
                  <p>Any patient who presents with signs of opioid overdose, or when
                  ...
                  individuals who have overdosed on opioids.&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  Naloxone can be given by intranasal spray, intramuscular (into
                  the muscle), subcutaneous (under the skin), or intravenous
                  injection.&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  17-19 The most rapid onset of action is achieved by
                  ...
                  that maintains spontaneous normal respiratory drive.&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  ...
                  route of administration.2,9,18&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  The intramuscular route of administration for naloxone may be
              ...
              <td style="width:40%; vertical-align:unset; font-size:13px; padding-left:10px; padding-right:10px;">
                  <p>More than one dose of naloxone may be needed to revive someone who is overdosing. Patients who have taken longer-acting opioids may require further intravenous bolus doses or an infusion of naloxone.21 Comfort the person being treated, as withdrawal triggered by naloxone can feel unpleasant. As a result, some persons become agitated or combative when this happens and need help to remain calm.</p>
                  <p>
                    <b style="color:#0a508c;">SAFETY OF NALOXONE.</b>
                    The safety profile of naloxone is remarkably high, especially when used in low doses and titrated to effect.2,9,17,22 When given to individuals who are not opioid-intoxicated or opioid-dependent, naloxone produces no clinical effects, even at high doses. Moreover, although rapid opioid withdrawal in tolerant patients may be unpleasant, it is not life-threatening. &emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    Naloxone can be used in life-threatening opioid overdose circumstances in pregnant women.23 &emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    The FDA has approved injectable naloxone, intranasal naloxone (called Narcan®
          ...
          <tr>&emsp;
            <td style="width:70%; border-right:1px solid black;font-size:14px; padding-right:10px;vertical-align:unset;">
              <p>
                ...
                <b style="color:#0a508c; font-size:30px;">STEP 5: MONITOR THE PERSON’S RESPONSE</b>
                <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;All patients should be monitored for recurrence of signs and
                ...
                monitoring.2,10&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                Most patients respond by returning to spontaneous breathing.
                ...
                naloxone to take effect.)2,5,10&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
obtain replacement naloxone as needed.</p>
          ...
          <table>
            <tr>&emsp;
              <td style="width:70%; padding-right:10px;border-right:1px solid black;vertical-align:unset;padding-left: 40px; padding-right: 10px;"> 
                <P style="line-height: 27px;"><span style="color: #0a508c; font-size:80px; float: left; line-height: 1;">O</span><span>pioid overdose is a major public health problem. In 2014, 28,647 of drug overdose deaths involved some type of opioid, including heroin. 14,19 Overdose involves both men and women of all ages, ethnicities, and demographic and economic characteristics, and involves both illicit opioids such as heroin and, increasingly, prescription opioid analgesics such as oxycodone, hydrocodone, fentanyl, and methadone.4</span>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Physicians and other health care providers can make a major contribution toward reducing the toll of opioid overdose through the care they take in prescribing opioid analgesics and monitoring patients’ response, as well as through their acuity in identifying and effectively addressing opioid overdose. Federally funded Continuing Medical Education (CME) courses are available at no charge at <span style="text-decoration: underline;"><a href="http://www.OpioidPrescribing.com" target="_blank">http://www.OpioidPrescribing.com</a></span> (a series of courses funded by the Substance Abuse and Mental Health Services Administration [SAMHSA])2.
                </P>
                <b style="color: #0a508c; font-size:30px;">OPIOID OVERDOSE</b>
                <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The risk of opioid overdose can be minimized through adherence to the following clinical practices, which are supported by a considerable body of evidence. 2,10,22,24</p>
          ...
          <table>
            <tr>&emsp;
              ...
              supply (visit <a href="http://www.fda.gov/ForConsumers/Consumer-
              Updates/ucm101653.htm" target="_blank">http://www.fda.gov/ForConsumers/Consumer-
              Updates/ucm101653.htm</a> for advice from the United States
        ...
        <br>
          ...
          <table>
            <tr>&emsp;
              <td style="width:70%;vertical-align:unset;border-right:1px solid black;">
                <b style="color:#0a508c; font-size:25px;">LEGAL AND LIABILITY CONSIDERATIONS</b>
                ...
                policies is available at <span style="text-decoration:underline;"><a href="http://www.prescribetoprevent.org" target="_blank">http://www.prescribetoprevent.org</a></span> or from
                individual state medical boards.</p>
                <b style="color:#0a508c; font-size:25px;">CLAIMS CODING AND BILLING</b>
...
<br>
          ...
          <table style="width:100%;">
            <tr>
              <td>
                <p><b style="color:#0a508c; font-size:30px;">RESOURCES FOR PRESCRIBERS</b></p>
                <p>Additional information on prescribing opioids for chronic pain is available at the following websites: <span style="text-decoration:underline;"><a href="http://www.opioidprescribing.com" target="_blank">http://www.opioidprescribing.com</a></span>.</p>

                  <p>Sponsored by the Boston University School of Medicine, with support from SAMHSA, this site present course modules on various aspects of prescribing opioids for chronic pain. To view the list of courses and to register, go to <span style="text-decoration:underline;"><a href="http://www.opioidprescribing.com/overview" target="_blank">http://www.opioidprescribing.com/overview</a></span>. CME credits are available at no charge.</p>

                    <p><span style="text-decoration:underline;"><a href="http://pcss-o.org" target="_blank">http://pcss-o.org</a></span> or <a href="www.pcssmat.org." target="_blank">www.pcssmat.org</a> Sponsored by the American Academy of Addiction Psychiatry in collaboration with other specialty societies and with support from SAMHSA, the Providers’ Clinical Support System offers multiple resources related to opioid prescribing and the diagnosis and management of opioid use disorder.</p>

                    <p><span style="text-decoration:underline;"><a href="http://www.er-la-opioidrems.com/IwgUI/rems/home.action" target="_blank">http://www.er-la-opioidrems.com/IwgUI/rems/home.action</a></span>. As required by the FDA under a risk management program for extended-release and long-acting opioid analgesics, this website provides physician training and patient education on the use of such medications.</p>

                    <p><span style="text-decoration:underline;"><a href="http://www.medscape.com" target="_blank">http://www.medscape.com</a></span>. One course module sponsored by SAMHSA on Screening, Brief Intervention, and Referral to Treatment (SBIRT) can be accessed at <span style="text-decoration:underline;"><a href="http://www.medscape.org/viewarticle/830331" target="_blank">http://www.medscape.org/viewarticle/830331</a></span>. CME/CE credits are available at no charge.</p>

                    <p><span style="text-decoration:underline;"><a href="http://prescribetoprevent.org" target="_blank">http://prescribetoprevent.org</a></span>. Compiled by prescribers, pharmacists, public health workers, lawyers, and researchers working on overdose prevention and naloxone access, this privately funded site provides resources to help health care providers educate their patients to reduce overdose risk and provide naloxone rescue kits to patients.</p>
              </td>
            </tr>
          </table>
          <br>
            ...
            <tr>&emsp;
              <td style="width:33%;vertical-align:unset;border-right:1px solid black;">
                <b style="color:#0a508c;">WHAT IS NALOXONE?</b>                
                  ...
                  <p style="padding-right:10px;text-decoration:underline;"><a class="wrap" href="http://www.fda.gov/drugs/drugsafety/postmarketdrugsafetyinformationforpatientsandproviders/ucm472923.htm." target="_blank">http://www.fda.gov/drugs/drugsafety/postmarketdrugsafetyinformationforpatientsandproviders/ucm472923.htm.</a></p>
              ...
              <td style="width:33%;vertical-align:unset;padding-left:10px;padding-right:10px;">
                  <b style="color:#0a508c;">STORE NALOXONE IN A SAFE PLACE</b><br>
...
<br/>
                  ...
                  <p style="text-decoration:underline;"><a class="wrap" href="http://www.fda.gov/drugs/drugsafety/postmarketdrugsafetyinformationforpatientsandproviders/ucm472923.htm." target="_blank">http://www.fda.gov/drugs/drugsafety/postmarketdrugsafetyinformationforpatientsandproviders/ucm472923.htm.</a></p> 
              </td>
            </tr>
          </table>
          ...
          <table>
            <tr>
              <td style="width:70%;vertical-align:unset;border-right:1px solid black;">
                  ...
                  <b style="color:#0a508c;font-size:30px;">FINDING A NETWORK OF SUPPORT</b>
        ...
        <br>
            ...
            <tr>&emsp;
              <td>
                ...
                <ul style="list-style-type: square; color:#0a508c;">
                  ...
                  <li><span style="color:#000;">Buprenorphine Treatment Physician Locator: <a style="text-decoration:underline;"><a href="http://www.samhsa.gov/medication-assisted-treatment/physician-program-data/treatment-physician-locator" target="_blank">http://www.samhsa.gov/medication-assisted-treatment/physician-program-data/treatment-physician-locator</a></span></li>
                  <li><span style="color:#000;">State Substance Abuse Agencies: <a href="https://findtreatment.samhsa.gov/TreatmentLocator/faces/about.jspx" target="_blank">https://findtreatment.samhsa.gov/TreatmentLocator/faces/about.jspx</a></span></li>
                </ul>
                <b style="color:#0a508c;">Centers for Disease Control and Prevention (CDC):</b>
                <p style="text-decoration:underline;"><a href="http://www.cdc.gov/drugoverdose/epidemic" target="_blank">http://www.cdc.gov/drugoverdose/epidemic</a></p>
                
                <b style="color:#0a508c;">National Institutes of Health (NIH), National Center for Biotechnical Information:</b>
                <p style="text-decoration:underline;"><a href="http://www.ncbi.nlm.nih.gov" target="_blank">http://www.ncbi.nlm.nih.gov</a></p>

                <b style="color:#0a508c;">Partnership for Drug-Free Kids:</b>
                <p style="text-decoration:underline;"><a href="http://www.drugfree.org/join-together/opioid-overdose-antidote-being-more-widely-distributed-to-those-who-use-drugs" target="_blank">http://www.drugfree.org/join-together/opioid-overdose-antidote-being-more-widely-distributed-to-those-who-use-drugs</a></p>

                <b style="color:#0a508c;">Project Lazarus:</b>
                <p style="text-decoration:underline;"><a href="http://www.projectlazarus.org" target="_blank">http://www.projectlazarus.org</a></p>

                <b style="color:#0a508c;">Harm Reduction Coalition:</b>
                <p style="text-decoration:underline;"><a href="http://www.harmreduction.org" target="_blank">http://www.harmreduction.org</a></p>

                <b style="color:#0a508c;">Overdose Prevention Alliance:</b>
                <p style="text-decoration:underline;"><a href="http://www.overdosepreventionalliance.org" target="_blank">http://www.overdosepreventionalliance.org</a></p>

                <b style="color:#0a508c;">Toward the Heart:</b>
                <p style="text-decoration:underline;"><a href="http://www.towardtheheart.com/naloxne" target="_blank">http://www.towardtheheart.com/naloxne</a></p>
          ...
          <table>
            <tr>&emsp;
              <td>
                <p>1 Number and age-adjusted rates of drug-poisoning deaths involving opioid analgesics and heroin: UnitedStates, 2000–2014. Centers for Disease Control and Prevention Website.<a style="text-decoration:underline;"><a href="http://www.cdc.gov/nchs/data/health_policy/AADR_drug_poisoning_involving_OA_Heroin_US_2000-2014.pdf" target="_blank">http://www.cdc.gov/nchs/data/health_policy/AADR_drug_poisoning_involving_OA_Heroin_US_2000-2014.pdf</a> Accessed January 11, 2016.</p>

                <p>2 Beletsky LB, Rich JD, Walley AY. Prevention of fatal opioid overdose. JAMA. 2012;308(18):1863-1864.</p>

                <p>3 Centers for Disease Control and Prevention. CDC Vital Signs: Opioid painkiller prescribing—where you live makes a difference. <a style="text-decoration:underline;"><a href="http://www.cdc.gov/vitalsigns/opioid-prescribing" target="_blank">http://www.cdc.gov/vitalsigns/opioid-prescribing</a>. Published July 1, 2014. Accessed January 11, 2016.</p>
                ...
                <p>11 Davis C. Legal interventions to reduce overdose mortality: naloxone access and overdose Good Samaritan laws. <a style="text-decoration:underline;"><a href="https://www.networkforphl.org/_asset/qz5pvn/network-naloxone-10-4.pdf" target="_blank">https://www.networkforphl.org/_asset/qz5pvn/network-naloxone-10-4.pdf</a>. Updated September 2015. Accessed January 11, 2016.</p>
          ...
          <table>
            <tr>&emsp;
              <td>
                ...
                <p>17 Rx List. <a style="text-decoration:underline;"><a href="http://www.rxlist.com" target="_blank">http://www.rxlist.com</a>. Accessed March 24, 2013.</p>
                
                <p>18 Drugs.com. <a style="text-decoration:underline;"><a href="http://www.drugs.com" target="_blank">http://www.drugs.com</a>. Accessed March 24, 2013.</p>

                <p>19 FDA moves quickly to approve easy-to-use nasal spray to treat opioid overdose. Food and Drug Administration
                Website:.<a style="text-decoration:underline;"><a href="http://www.fda.gov/NewsEvents/Newsroom/PressAnnouncements/ucm473505.htm" target="_blank">http://www.fda.gov/NewsEvents/Newsroom/PressAnnouncements/ucm473505.htm</a>.
                ...
                <p>30 Behavioral Health Treatment Services Locator: <a style="text-decoration:underline;" href="https://findtreatment.samhsa.gov" target="_blank">https://findtreatment.samhsa.gov</a> to search by address, city, or zip code.</p>
              </td>
            </tr>
          </table>

          <a href='../../forms/samhsa_form/pdf_form.php' class='btn btn-primary btn-sm ' title='View PDF' onclick='top.restoreSession()'><span>PDF</span></a>
