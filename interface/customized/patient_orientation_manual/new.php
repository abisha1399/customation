...
if ($formid) {
    $sql = "SELECT * FROM `form_patient_orientation` WHERE id=? AND pid = ? AND encounter = ?";
...
$multidrop=$check_res["multidrop"];
$multi_arr=explode(",",$multidrop);
?>
<html>
    <head>
    ...
    <style>
        ...
        <div class="container mt-3">
            <div class="row"> 
                <form method="post" name="my_form" action="<?php echo $rootdir; ?>/customized/patient_orientation_manual/save.php?id=<?php echo attr_url($formid); ?>">
                    <input type="hidden" name="csrf_token_form" value="<?php echo attr(CsrfUtils::collectCsrfToken()); ?>" />
                <!-- <div style="border:1px solid #dee2e6;">  -->
                    <table class="admissionord" style="width:100%; "> 
                        <tr>
                            <td style="width:100%;">
                                <h4 class="text-center mt-2"><b>Patient Orientation Manual</b></h4>
                            </td>  
                        </tr>
                    </table>  
                    <br/>     
                    <table class="admissionord" style="width:100%;table-layout:fixed;display:table;"> 
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <p><div contentEditable="true" class="text_edit"><?php echo $check_res['text2']??'CNT is the first and only Medically Monitored Ambulatory Detoxification facility in New Jersey
...
from 9am-7pm 7 days a week.'?></div><input type="hidden" name="text2" id="text2"></p></p>
                                 </td>
                            </tr>
                            <tr>
                                <td style="text-align:center">
                            ...
                            <tr>
                                <td>
                                <p><div contentEditable="true" class="text_edit"><?php echo $check_res['text3']??'
                                    <ol>
...
groups, advocacy services, and legal services.</li>
                                    ...
                                    </ol>    '?></div><input type="hidden" name="text3" id="text3">                                
                                </td>
                            </tr>
                            <tr>
                                <td style="text-align:center">
...
client a copy of the above numbers upon admission to the program).</b></p>
                            ...
                            <tr>
                                <td >
 <p><div contentEditable="true" class="text_edit"><?php echo $check_res['text4']??'
 This handbook is provided to you to help orient you to our agency. If you have questions
or need further Information, please see a staff member. Included in the handbook is the
following:'?></div><input type="hidden" name="text4" id="text4"></p>
                                 </td>
                            </tr>
                            <tr>
                                <td>
                                <div contentEditable="true" class="text_edit"><?php echo $check_res['text5']??'<ul>
...
</ul>'?></div><input type="hidden" name="text5" id="text5">
                                 </td>
                            </tr>
                            <tr>
                                <td >
...
732-560-1080. The Answering Service will contact the Nursing Director.</p>
                            ...
                            <tr>
                                <td >
 <p>
 <b><u> Levels of Care offered by Center for Network Therapy (CNT)</u></b><br/>
 <div contentEditable="true" class="text_edit"><?php echo $check_res['text6']??'
...
<li>Family/ Caregiver Functioning</li></ul>'?></div><input type="hidden" name="text6" id="text6">
                                 </td>
                            </tr>
                            <tr>
                                <td >
                                <p><div contentEditable="true" class="text_edit"><?php echo $check_res['text7']??'
                                <b>Admissions & Reviews</b><br/>Dr. Cidambi reviews all admissions. Reviews are conducted on a regular basis. Continuation of
...
<li>Input from the client & counselor</li></ul>'?></div><input type="hidden" name="text7" id="text7">
<br/>
<p><div contentEditable="true" class="text_edit"><?php echo $check_res['text8']??'
<b>Discharges</b><br/>Dr. Cidambi approves all discharges. Discharge criteria are also based upon the protocols and
patient progress in treatment as verified by:
<ul><li>Achievement of goals & objectives from the individualized treatment plan</li>
<li>Results of random urine screening</li>
<li>Input from the client & counselor</li></ul>'?></div><input type="hidden" name="text8" id="text8">

<h5><b>SERVICES:</b></h5>
<p><div contentEditable="true" class="text_edit"><?php echo $check_res['text9']??'
Center for Network Therapy offers a variety of intensive outpatient services, which are
...
four hours and written results are back within forty-eight hours.'?></div><input type="hidden" name="text9" id="text9"></p>
                                 </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <p><div contentEditable="true" class="text_edit"><?php echo $check_res['text10']??'
                                    <b><u>Assessment</u></b> – The assessment provides a comprehensive overview of the patient and
...
coordination.'?></div><input type="hidden" name="text10" id="text10"></p>
                                 </td>
                            </tr>
                            <tr>
                                <td>
                                    <p><div contentEditable="true" class="text_edit"><?php echo $check_res['text11']??'
                                    <u>Partial Hospitalization Program</u> – This five hour, five day a week group program is designed for the
...
is part of this program.'?></div><input type="hidden" name="text11" id="text11"></p>
                                 </td>
                            </tr>
                            <tr>
                                <td>
                                     <p><div contentEditable="true" class="text_edit"><?php echo $check_res['text12']??'
                                     <u>Ambulatory detoxification</u> - The ambulatory Detox program is approximately five to seven days in length. An individual completes registration and assessment. Once a supervisor reviews the case, the
...
recovery for sustainability.'?></div><input type="hidden" name="text12" id="text12"></p>
                                 </td>
                            </tr>
                            <tr>
                                <td>
                                     <p><div contentEditable="true" class="text_edit"><?php echo $check_res['text13']??'<u>Individual and Family Counseling:</u> This service is available as a part of an existing group program or
as a stand-alone service.'?></div><input type="hidden" name="text13" id="text13"></p>
                                 </td>
                            </tr>
                            <tr>
                                <td>
                                <p><div contentEditable="true" class="text_edit"><?php echo $check_res['text14']??'<u>Relapse Prevention:</u><br/><br/>
This group program is designed to provide support to those patients who have experienced a relapse
after a period of sobriety.'?></div><input type="hidden" name="text14" id="text14"></p>
                                 </td>
                            </tr>
                            <tr>
                                <td>
                                <p><div contentEditable="true" class="text_edit"><?php echo $check_res['text15']??'<u>Assessment –</u> The assessment provides a comprehensive overview of the patient and his/her problems.
...
the assessment process.'?></div><input type="hidden" name="text15" id="text15"></p>
                                 </td>
                            </tr>
                            <tr>
                                <td>
                                <p><div contentEditable="true" class="text_edit"><?php echo $check_res['text16']??'
                                <u>Individual and Family Counseling</u> – This service is available as either a part of an existing group
program or as a stand-alone service.'?></div><input type="hidden" name="text16" id="text16"></p>
                                 </td>
                            </tr>
                            <tr>
                                <td style="text-align:center;">
                            ...
                            <tr>
                                <td >                                 
                                 <p><div contentEditable="true" class="text_edit"><?php echo $check_res['text17']??'
                                 As a participant in this agency’s services, I agree to abide by the following rules:</p>
                                 <ol>
...
be subject to discharge.</li>
                                 </ol>'?></div><input type="hidden" name="text17" id="text17">
                                 </td>
                            </tr>
                            <tr>
                                <td>
                                <div contentEditable="true" class="text_edit"><?php echo $check_res['text18']??'
...
question the appropriateness of the attire, it probably isn’t appropriate.</p>'?></div><input type="hidden" name="text18" id="text18"><h4><u>UNACCEPTABLE ATTIRE</u></h4>
<div contentEditable="true" class="text_edit"><?php echo $check_res['text19']??'
<ul>
...
</ul>'?></div><input type="hidden" name="text19" id="text19">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                  <p><div contentEditable="true" class="text_edit"><?php echo $check_res['text20']??'
                                  <b><u>Description of Continuous Quality Improvement Program</u></b><br/>Center for Network Therapy has a philosophy of Continuous Quality Improvement (CQI) for the
organization and a Quality Improvement program to insure the practice of a QI philosophy and
continuous improvements to the organization.'?></div><input type="hidden" name="text20" id="text20"><br><br/>

<div contentEditable="true" class="text_edit"><?php echo $check_res['text21']??'
<b>Patient Input</b><br/>
...
with services. You may also complete a suggestion box at any time (located in the main lobby).'?></div><input type="hidden" name="text21" id="text21">
<br><br/>
<div contentEditable="true" class="text_edit"><?php echo $check_res['text22']??'
<b>Family Member Input</b><br/>
Often times, family members are good sources of information on how well the agency was able to
help a client. CNT may ask you to take a survey home for a family member to complete. These
surveys and suggestion cards are also available to family members in the main lobby.'?></div><input type="hidden" name="text22" id="text22">
<br><br/>
<div contentEditable="true" class="text_edit"><?php echo $check_res['text23']??'
<b>Outcomes & Follow-up</b><br/>
The agency is also interested in the effectiveness of the services provided; as a result, you may be
...
sources.'?></div><input type="hidden" name="text23" id="text23">
<br><br/>
<div contentEditable="true" class="text_edit"><?php echo $check_res['text24']??'
<b>How will this information be used?</b><br/>
...
serve the patients more effectively. Thank you'?></div><input type="hidden" name="text24" id="text24">
<br/><br/>

<div contentEditable="true" class="text_edit"><?php echo $check_res['text25']??'
...
approved Compliance Program.'?></div><input type="hidden" name="text25" id="text25"></p>
                                </td>
                            </tr>
                            
                            <tr>
                                <td>
                                <div contentEditable="true" class="text_edit"><?php echo $check_res['text26']??'
                                    <h4>THIS NOTICE DESCRIBES HOW MEDICAL AND DRUG AND ALCOHOL RELATED
...
disclosure. You may revoke any such written consent verbally or in writing.<br/><br/>

<b>Note: Special revocation restrictions apply to certain releases to the criminal justice system.</b>
'?></div><input type="hidden" name="text26" id="text26">
<br/><br/>
<div contentEditable="true" class="text_edit"><?php echo $check_res['text27']??'
...
our website at <a href="http://www.recoverycnt.org/" target="_blank">http://www.recoverycnt.org/ </a>.'?></div><input type="hidden" name="text27" id="text27">

<br/><br/>
<div contentEditable="true" class="text_edit"><?php echo $check_res['text28']??'
...
Middlesex, NJ, 08846<br/>
732-560-1080'?></div><input type="hidden" name="text28" id="text28">
<br/><br/>
<div contentEditable="true" class="text_edit"><?php echo $check_res['text29']??'
Complaints must be in writing and you will not be retaliated against for filing such a complaint.
Violation of the Confidentiality Law by a program is a crime. Suspected violations of the Confidentiality Law
'?></div><input type="hidden" name="text29" id="text29">
<br/><br/>
<div contentEditable="true" class="text_edit"><?php echo $check_res['text30']??'
<b>NOTICE OF PRIVACY PRACTICES</b><br/>
<b>Effective Date: September 23, 2013</b><br/>
THIS NOTICE DESCRIBES HOW MEDICAL INFORMATION ABOUT YOU MAY BE USED AND
DISCLOSED AND HOW YOU CAN GET ACCESS TO THIS INFORMATION.
PLEASE REVIEW IT CAREFULLY.
'?></div><input type="hidden" name="text30" id="text30">
<br/><br/>
<div contentEditable="true" class="text_edit"><?php echo $check_res['text31']??'
If you have any questions about this Notice, please contact:<br/>
<b>Eddie Mann LSW, MSW, LCADC,CCS, Clinical Director</b><br/>
<b>Phone: 732-560-1080 Address: 333 Cedar Avenue Building B, Middlesex NJ 08846 at cntdirector@gmail.com</b>
'?></div><input type="hidden" name="text31" id="text31"></p>
                                </td>
                            </tr>                            
                            <tr>
                                <td>
                                <div contentEditable="true" class="text_edit"><?php echo $check_res['text32']??'
...
disclosures of your personal information that we are permitted to make:</p>'?></div><input type="hidden" name="text32" id="text32">

<div contentEditable="true" class="text_edit"><?php echo $check_res['text33']??'
...
data.</p>'?></div><input type="hidden" name="text33" id="text33">

<div contentEditable="true" class="text_edit"><?php echo $check_res['text34']??'
...
business operations.</p>'?></div><input type="hidden" name="text34" id="text34">

<div contentEditable="true" class="text_edit"><?php echo $check_res['text35']??'
<p><b><u>Treatment</u></b> - We may share your personal health information with your health care providers to
assist in coordinating your care.</p>'?></div><input type="hidden" name="text35" id="text35">

<div contentEditable="true" class="text_edit"><?php echo $check_res['text36']??'
...
information to your guardian or attorney in fact.</p>'?></div><input type="hidden" name="text36" id="text36">
<div contentEditable="true" class="text_edit"><?php echo $check_res['text37']??'
...
permission.</p>'?></div><input type="hidden" name="text37" id="text37">
<div contentEditable="true" class="text_edit"><?php echo $check_res['text38']??'
...
using and disclosing the genetic information in your health information for such purposes.</p>'?></div><input type="hidden" name="text38" id="text38">
<div contentEditable="true" class="text_edit"><?php echo $check_res['text39']??'
<p><b><u>POTENTIAL IMPACT OF OTHER APPLICABLE LAWS</b></u><br/>
...
records generally receive greater protections under federal law.</p>'?></div><input type="hidden" name="text39" id="text39">
                                </td>
                            </tr>
                                                       
                            <tr>
                                <td>
                                <div contentEditable="true" class="text_edit"><?php echo $check_res['text40']??'
...
Please contact us if you need assistance.</li>
                                    </ul>'?></div><input type="hidden" name="text40" id="text40">
                                </td>
                            </tr> 
                            <tr><td>
                            <div contentEditable="true" class="text_edit"><?php echo $check_res['text41']??'
...
The effective date of each Notice is listed on the first page in the top center.<br><br>'?></div><input type="hidden" name="text41" id="text41">
                            </td>
                            </tr> 
                            <tr><td>
                            <div contentEditable="true" class="text_edit"><?php echo $check_res['text42']??'
...
'?></div><input type="hidden" name="text42" id="text42">
<div contentEditable="true" class="text_edit"><?php echo $check_res['text43']??'
<h5><b>PROCEDURE:</b></h5>
<ol>
...
</ol>'?></div><input type="hidden" name="text43" id="text43">
                            </td>
                            </tr> 
                            <tr>
                                <td>
                                <div contentEditable="true" class="text_edit"><?php echo $check_res['text44']??'
...
methadone, and others.<p>'?></div><input type="hidden" name="text44" id="text44">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                <div contentEditable="true" class="text_edit"><?php echo $check_res['text45']??'
                               <b> Causes</b>
...
not know that opiates would fix the problem, they do not crave the drugs.</p>'?></div><input type="hidden" name="text45" id="text45"><b>Symptoms</b>
<div contentEditable="true" class="text_edit"><?php echo $check_res['text46']??'
...
<li>Nausea</li>
<li>Vomiting</li>
</ul>'?></div><input type="hidden" name="text46" id="text46">

<div contentEditable="true" class="text_edit"><?php echo $check_res['text47']??'
...
Fact Sheet<br/>
SIGNS & SYMPTOMS<br/><br/>'?></div><input type="hidden" name="text47" id="text47">
<div contentEditable="true" class="text_edit"><?php echo $check_res['text48']??'
...
Abdominal pain<br/>
Loss of appetite<br/>
Nausea<br/><br/>'?></div><input type="hidden" name="text48" id="text48">
<div contentEditable="true" class="text_edit"><?php echo $check_res['text49']??'
...
Deaths from chronic liver disease: <3% <br/>Leading indication for liver transplant</p>'?></div><input type="hidden" name="text49" id="text49">
                                </td>
                            </tr>
                            <tr><td>
                            <div contentEditable="true" class="text_edit"><?php echo $check_res['text50']??'    
...
Recommendations for Testing Based on Risk for HCV Infection</p>'?></div><input type="hidden" name="text50" id="text50">

<div contentEditable="true" class="text_edit"><?php echo $check_res['text51']??'
...
'?></div><input type="hidden" name="text51" id="text51">

<div contentEditable="true" class="text_edit"><?php echo $check_res['text52']??'
...
If you are HCV positive, do not donate blood, organs, or tissue.</p>'?></div><input type="hidden" name="text52" id="text52">

<div contentEditable="true" class="text_edit"><?php echo $check_res['text53']??'
...
10 persons. Drinking alcohol can make your liver disease worse.'?></div><input type="hidden" name="text53" id="text53">

<div contentEditable="true" class="text_edit"><?php echo $check_res['text54']??'
...
chronically infected.'?></div><input type="hidden" name="text54" id="text54">
</td>
                            </tr>
                            <tr><td><br/>
                            <div contentEditable="true" class="text_edit"><?php echo $check_res['text55']??'
...
*nausea, vomiting *abdominal pain *joint pain'?></div><input type="hidden" name="text55" id="text55"><br/><br/>
<div contentEditable="true" class="text_edit"><?php echo $check_res['text56']??'
<h4>CAUSE</h4>
...
<li>15-25% of chronically infected persons</li></ul>'?></div><input type="hidden" name="text56" id="text56">
<div contentEditable="true" class="text_edit"><?php echo $check_res['text57']??'
...
'?></div><input type="hidden" name="text57" id="text57">
<div contentEditable="true" class="text_edit"><?php echo $check_res['text58']??'
...
<li>Hemodialysis patients</li></ul>'?></div><input type="hidden" name="text58" id="text58"><h5><b><u>PREVENTION</u></b></h5>
<div contentEditable="true" class="text_edit"><?php echo $check_res['text59']??'
...
</ul>'?></div><input type="hidden" name="text59" id="text59">

<h5><b><u>VACCINE RECOMMENDATIONS</u></b></h5>
<div contentEditable="true" class="text_edit"><?php echo $check_res['text60']??'
<ul>
...
</ul>'?></div><input type="hidden" name="text60" id="text60">
<h5><b><u>TREATMENT & MEDICAL MANAGEMENT (National Institutes of Health fact sheet on treatment)</u></b></h5>
<div contentEditable="true" class="text_edit"><?php echo $check_res['text61']??'
...
<li>Drinking alcohol can make your liver disease worse.</li></ul>'?></div><input type="hidden" name="text61" id="text61">
<div contentEditable="true" class="text_edit"><?php echo $check_res['text62']??'
...
Revised 10.4.13</li></ul>'?></div><input type="hidden" name="text62" id="text62">
<br/>
<b>What is a sexually transmitted infection (STI)?</b>
<div contentEditable="true" class="text_edit"><?php echo $check_res['text63']??'
It is an infection passed from person to person through intimate sexual contact. STIs are also called sexually transmitted
diseases, or STDs.'?></div><input type="hidden" name="text63" id="text63">
<br/>
<b>How do you get an STI?</b><br/>
<div contentEditable="true" class="text_edit"><?php echo $check_res['text64']??'
...
without having intercourse. Not all STIs are spread the same way.'?></div><input type="hidden" name="text64" id="text64">
<br/>
<div contentEditable="true" class="text_edit"><?php echo $check_res['text65']??'
...
with other STIs, including HIV. Also, infection with some STIs makes it easier for you to get HIV if you are exposed.'?></div><input type="hidden" name="text65" id="text65">
<br/><b>What are the symptoms of STIs?</b>
<div contentEditable="true" class="text_edit"><?php echo $check_res['text66']??'
...
</div><input type="hidden" name="text66" id="text66">
                            </td></tr>
                        </tbody>
                    </table>
                    <br/><br/>
...
<div contentEditable="true" class="text_edit"><?php echo $check_res['text67']??'
...
</div><input type="hidden" name="text68" id="text68">
<p><b>How are STIs treated?</b></p>
<div contentEditable="true" class="text_edit"><?php echo $check_res['text69']??'
...
than the drugs your doctor will give you. But this is not true, and the safety of these products is not known.</p>'?>
</div><input type="hidden" name="text69" id="text69"><br/>
<p><b>What can I do to keep from getting an STI?</b></p>
<div contentEditable="true" class="text_edit"><?php echo $check_res['text70']??'
...
</div><input type="hidden" name="text70" id="text70"><br/>
<br/>
<p><b>How do STIs affect pregnant women and their babies?</b></p>
<div contentEditable="true" class="text_edit"><?php echo $check_res['text71']??'
...
birth.</p>'?>
</div><input type="hidden" name="text71" id="text71"><br/>
<p><b>What can pregnant women do to prevent problems from STIs?</b></p>
<div contentEditable="true" class="text_edit"><?php echo $check_res['text72']??'
...
<p>Did you know?
<p>If you have HIV, do not breastfeed. You can pass the virus to your baby.
...
touch the sore(s) while pumping, you should throw the milk away.
...
treatments for STIs are safe to use while breastfeeding.
...
</div><input type="hidden" name="text72" id="text72"><br/>
<br/>
...
<div contentEditable="true" class="text_edit"><?php echo $check_res['text73']??'
...
</div><input type="hidden" name="text73" id="text73">
<b>
How is TB Spread?</b>
<div contentEditable="true" class="text_edit"><?php echo $check_res['text74']??'
TB is spread through the air from one person to another. The bacteria are put into the air when a person
with TB disease of the lungs or throat coughs or sneezes. People nearby may breathe in these bacteria and
become infected.<br/>
...
</div><input type="hidden" name="text74" id="text74">
<b>What is latent TB infection?</b>
<div contentEditable="true" class="text_edit"><?php echo $check_res['text75']??'
...
active later. This is called latent TB infection. People with latent TB infection
<ul>
<li>Have no symptoms
<li>Do not feel sick
...
</div><input type="hidden" name="text75" id="text75">
<b>What is TB disease?</b>
<div contentEditable="true" class="text_edit"><?php echo $check_res['text76']??'
...
Revised 10.4.13</p>'?>
</div><input type="hidden" name="text76" id="text76">
                                </td> 
                            </tr>
                            <tr><td>
...
receipt.</p>
                    ...
                    <table class="admissionord" style="width:100%;table-layout:fixed;display:table;">
                        <tbody>
                            <tr>
                                <td></td>
                                <td>Client's Signature : <i class="fas fa-pen pen_icon" data-toggle="modal" data-target="#myModal" style="font-size:25px;"></i>
                                    <i class="fas fa-search view_icon" id="cli_sign" data-toggle="modal" data-target="#viewModal" style="font-size:25px;display:none"></i><input type="hidden" name="clisign" id="clisign" value="<?php echo text($check_res['clisign']); ?>"   />
                                </td>
                                <td>Date : <input type="date" name="clidate" value="<?php echo text($check_res['clidate']); ?>" /></td>
                    ...
                    <table class="admissionord" style="width:100%;table-layout:fixed;display:table;">
                        <tbody>
                            ...
                            <tr>
                                <td></td>
                                <td>Family Signature : <i class="fas fa-pen pen_icon" data-toggle="modal" data-target="#myModal" style="font-size:25px;"></i>
                                    <i class="fas fa-search view_icon" id="fam_sign" data-toggle="modal" data-target="#viewModal" style="font-size:25px;display:none"></i><input type="hidden" name="famsign" id="famsign" value="<?php echo text($check_res['famsign']); ?>"   />
                                </td>
                                <td>Date : <input type="date" name="famdate" value="<?php echo text($check_res['famdate']); ?>" /></td>                               
                            </tr>
                        </tbody>
                    </table>
                    <br/><br/>
                    <table class="admissionord" style="width:100%;table-layout:fixed;display:table;">
                        <tbody>
                            ...
                            <tr>
                                <td></td>
                                <td>Doctors/ CNT Representative Signature: <i class="fas fa-pen pen_icon" data-toggle="modal" data-target="#myModal" style="font-size:25px;"></i>
                                    <i class="fas fa-search view_icon" id="doc_sign" data-toggle="modal" data-target="#viewModal" style="font-size:25px;display:none"></i><input type="hidden" name="docsign" id="docsign" value="<?php echo text($check_res['docsign']); ?>"   />
                                </td>
                                <td>Date : <input type="date" name="docdate" value="<?php echo text($check_res['docdate']); ?>" /></td>                               
                            </tr>
                        </tbody>
                    </table>
                <!-- </div>        -->
