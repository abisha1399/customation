...
<body>
    <div class="container mt-3">
        <div class="row">
            <form method="post" name="my_form" action="<?php echo $rootdir; ?>/customized/admission_orders/save.php?id=<?php echo attr_url($formid); ?>">
                ...
                <table class="table table-bordered mb-2 admissionord" style="width:100%;table-layout:fixed;display:table;margin-top: -17px;">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label class="ml-2"><input type=checkbox name='check2' value="0" <?php if ($check_res["check2"] == "0") {
                                                                                                    echo "checked";
                                                                                                }; ?>> BID</label>
                            <label class="ml-2"><input type=checkbox name='check3' value="0" <?php if ($check_res["check3"] == "0") {
                                                                                                    echo "checked";
                ...
                <table class="table table-bordered admissionord" style="width:100%;table-layout:fixed;display:table;margin-top:-17px;">
                    <tr>
                        ...
                        <td>
                            ...
                            <label><input type=checkbox class="ml-3" name='check5' value="0" <?php if ($check_res["check5"] == "0") {
                                                                                                    echo "checked";
                                                                                                }; ?>> No</label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <label><input type=checkbox class="ml-3" name='check7' value="0" <?php if ($check_res["check7"] == "0") {
                                                                                                    echo "checked";
                                                                                                }; ?>> No</label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <label><input type=checkbox class="ml-3" name='check9' value="0" <?php if ($check_res["check9"] == "0") {
                                                                                                    echo "checked";
                                                                                                }; ?>> No</label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <label><input type=checkbox class="ml-3" name='check11' value="0" <?php if ($check_res["check11"] == "0") {
                                                                                                    echo "checked";
                                                                                                }; ?>> No</label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <label><input type=checkbox class="ml-3" name='check13' value="0" <?php if ($check_res["check13"] == "0") {
                                                                                                    echo "checked";
                                                                                                }; ?>> No</label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <label><input type=checkbox class="ml-3" name='check15' value="0" <?php if ($check_res["check15"] == "0") {
                                                                                                    echo "checked";
                                                                                                }; ?>> No</label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <label><input type=checkbox class="ml-3" name='check17' value="0" <?php if ($check_res["check17"] == "0") {
                                                                                                    echo "checked";
                                                                                                }; ?>> No</label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <label><input type=checkbox class="ml-3" name='check19' value="0" <?php if ($check_res["check19"] == "0") {
                                                                                                    echo "checked";
                                                                                                }; ?>> No</label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <label><input type=checkbox class="ml-3" name='check21' value="0" <?php if ($check_res["check21"] == "0") {
                                                                                                    echo "checked";
                                                                                                }; ?>> No</label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <label><input type=checkbox class="ml-3" name='check23' value="0" <?php if ($check_res["check23"] == "0") {
                                                                                                    echo "checked";
                                                                                                }; ?>> No</label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <label><input type=checkbox class="ml-3" name='check25' value="0" <?php if ($check_res["check25"] == "0") {
                                                                                                    echo "checked";
                                                                                                }; ?>> No</label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <label><input type=checkbox class="ml-3" name='check27' value="0" <?php if ($check_res["check27"] == "0") {
                                                                                                    echo "checked";
                                                                                                }; ?>> No</label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <label><input type=checkbox class="ml-3" name='check29' value="0" <?php if ($check_res["check29"] == "0") {
                                                                                                    echo "checked";
                                                                                                }; ?>> No</label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <label><input type=checkbox class="ml-3" name='check31' value="0" <?php if ($check_res["check31"] == "0") {
                                                                                                    echo "checked";
                                                                                                }; ?>> No</label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <label><input type=checkbox class="ml-3" name='check33' value="0" <?php if ($check_res["check33"] == "0") {
                                                                                                    echo "checked";
                                                                                                }; ?>> No</label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <label><input type=checkbox class="ml-3" name='check35' value="0" <?php if ($check_res["check35"] == "0") {
                                                                                                    echo "checked";
                                                                                                }; ?>> No</label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <label><input type=checkbox class="ml-3" name='check37' value="0" <?php if ($check_res["check37"] == "0") {
                                                                                                    echo "checked";
                                                                                                }; ?>> No</label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <label><input type=checkbox class="ml-3" name='check39' value="0" <?php if ($check_res["check39"] == "0") {
                                                                                                    echo "checked";
                                                                                                }; ?>> No</label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <label><input type=checkbox class="ml-3" name='check41' value="0" <?php if ($check_res["check41"] == "0") {
                                                                                                    echo "checked";
                                                                                                }; ?>> No</label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <label><input type=checkbox name='check42' value="0" <?php if ($check_res["check42"] == "0") {
                                                                                        echo "checked";
                                                                                    }; ?>> Yes</label>
                            <label><input type=checkbox class="ml-3" name='check43' value="0" <?php if ($check_res["check43"] == "0") {
                                                                                                    echo "checked";
                                                                                                }; ?>> No</label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <label><input type=checkbox name='check44' value="0" <?php if ($check_res["check44"] == "0") {
                                                                                        echo "checked";
                                                                                    }; ?>> Yes</label>
                            <label><input type=checkbox class="ml-3" name='check45' value="0" <?php if ($check_res["check45"] == "0") {
                                                                                                    echo "checked";
                                                                                                }; ?>> No</label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <label><input type=checkbox class="ml-3" name='check47' value="0" <?php if ($check_res["check47"] == "0") {
                                                                                                    echo "checked";
                                                                                                }; ?>> No</label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <label><input type=checkbox name='check48' value="0" <?php if ($check_res["check48"] == "0") {
                                                                                        echo "checked";
                                                                                    }; ?>> Yes</label>
                            <label><input type=checkbox class="ml-3" name='check49' value="0" <?php if ($check_res["check49"] == "0") {
                                                                                                    echo "checked";
                                                                                                }; ?>> No</label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <label><input type=checkbox name='check50' value="0" <?php if ($check_res["check50"] == "0") {
                                                                                        echo "checked";
                                                                                    }; ?>> Yes</label>
                            <label><input type=checkbox class="ml-3" name='check51' value="0" <?php if ($check_res["check51"] == "0") {
                                                                                                    echo "checked";
                                                                                                }; ?>> No</label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <label><input type=checkbox name='check52' value="0" <?php if ($check_res["check52"] == "0") {
                                                                                        echo "checked";
                                                                                    }; ?>> Yes</label>
                            <label><input type=checkbox class="ml-3" name='check53' value="0" <?php if ($check_res["check53"] == "0") {
                                                                                                    echo "checked";
                                                                                                }; ?>> No</label>
                        </td>
                    </tr>
