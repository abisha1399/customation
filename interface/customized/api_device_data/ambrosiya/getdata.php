...
$result1=sqlQuery("SELECT pid,fname,lname,ambrosiasys_email,ambrosiasys_password FROM patient_data WHERE ambrosiasys_email!='' AND ambrosiasys_password!='' AND pid=?",array($pid));
if(!empty($result1)){
    ...
    {
        echo 'patient have no email id';
          
    }
}
else{
    echo "ambrosiya not connected";
}
