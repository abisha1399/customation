...
function form_nutrition_report($pid, $encounter, $cols, $id)
{
    $count=0;
    $sql = "SELECT * FROM `form_nutrition` WHERE id=$id AND pid =$pid AND encounter =$encounter";
    ...
    if ($data) {
        ...
        <table style='width: 100%;'>
            <tr>
                ...
                <td><span class=bold><?php echo xlt('Nursing Content Form'); ?></span></td>
            </tr><br>
            <tr>
                <th><label><?php echo xlt('  favourite food :'); ?></label></th>
                <td><span class=text style="margin-left: -1121px;"><?php echo xlt(text($data['name1'])); ?></span></td>
            </tr>
           
            <tr>
            <th><label><?php echo xlt(' other comments :'); ?></label></th>
